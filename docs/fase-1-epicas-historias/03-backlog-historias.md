...
`historias-de-usuario/`, usando `docs/plantillas/plantilla-historia-usuario.md`. Las
historias marcadas con ✅ en la columna **Detalle** ya tienen ese archivo; el resto lo debe
crear el integrante responsable como parte del "terminado" de la fase 1
(ver `04-asignacion-equipo.md`).
